...
void MainWindow::setupActions()
{
    ...
    addAction(Actions["keyframesTypeEaseOutSinuAction"]);
    addAction(Actions["keyframesTypeEaseOutQuadAction"]);
    addAction(Actions["keyframesTypeEaseOutCubeAction"]);
    addAction(Actions["keyframesTypeEaseOutQuartAction"]);
    addAction(Actions["keyframesTypeEaseOutQuintAction"]);
    addAction(Actions["keyframesTypeEaseOutExpoAction"]);
    addAction(Actions["keyframesTypeEaseOutCircAction"]);
    addAction(Actions["keyframesTypeEaseOutBackAction"]);
    addAction(Actions["keyframesTypeEaseOutElasAction"]);
    addAction(Actions["keyframesTypeEaseOutBounAction"]);
