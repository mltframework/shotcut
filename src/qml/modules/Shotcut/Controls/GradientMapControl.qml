...
GridLayout {
        ...
        Rectangle {
            ...
            onXChanged: {
                if (stopArea.drag.active) {
                    ...
                    gradientMap._setStopPosition(stopIndex, position);
            ...
            Shotcut.ColorDialog {
                ...
                onAccepted: gradientMap._setStopColor(handleRect.stopIndex, String(selectedColor), getPosition())
            }
            ...
            MouseArea {
                ...
                drag.onActiveChanged: {
                    if (!drag.active) {
                        ...
                        stopPosition.value = position * 100;
                        gradientMap._setStopColor(handleRect.stopIndex, String(handleRect.color), position);
    ...
    Shotcut.DoubleSpinBox {
        ...
        to: stops.length
        stepSize: 1
        onValueChanged: stopPosition.value = parent.stops[value - 1].position * 100
    }
