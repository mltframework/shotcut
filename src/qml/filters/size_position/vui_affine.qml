...
Flickable {
    ...
    Component.onCompleted: {
        ...
        rectangle.setHandles(filter.getRect('transition.geometry'))
    }

    Connections {
        target: filter
        onChanged: rectangle.setHandles(filter.getRect('transition.geometry'))
    }
    ...
    Item {
        ...
        RectangleControl {
            ...
            borderSize: 2.0 / zoom
            onRectChanged: {
                filter.set('transition.geometry', '%1%/%2%:%3%x%4%'
                ...
                console.log('' + filter.get('transition.geometry'))
            }
        }
    }
}
