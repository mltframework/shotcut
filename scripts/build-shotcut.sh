...
X265_HEAD=0
X265_REVISION="9e551a994f970a24f0e49bcebe3d43ef08448b01"
LIBVPX_HEAD=0
...
function set_globals {
  ...
  REPOLOCS[7]="https://github.com/Shaik-Sirajuddin/shotcut.git"
...
function install_shotcut_linux {
  ...
  cmd install -p -c "$QTDIR"/lib/libQt6{Charts,Concurrent,Core,DBus,Gui,LabsFolderListModel,Multimedia,MultimediaQuick,Network,OpenGL,OpenGLWidgets,Qml,QmlMeta,QmlModels,QmlWorkerScript,Quick,QuickControls2*,QuickDialogs2,QuickDialogs2QuickImpl,QuickDialogs2Utils,QuickLayouts,QuickShapes,QuickTemplates2,QuickWidgets,Sql,Svg,SvgWidgets,UiTools,WaylandClient,WaylandEglClientHwIntegration,WebSockets,Widgets,Xml,X11Extras,XcbQpa}.so.6 "$FINAL_INSTALL_DIR"/lib
